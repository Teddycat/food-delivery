    ...
    <section class="news-item main-content">
        ...
        <div class="wrapper">
            <div class="content-wrapper">
                ...
                <div class="medium-title mb10"><?= $agreement['static_title'] ?></div>
                <div class="news-item">
                    <div class="clearfix">
                        ...
                        <div class="h3 medium text-black mb20">
                            <?= $agreement['static_preview'] ?>
                        </div>
                        <img src="../<?= Html::encode($agreement['static_img']) ?>" alt="" class="left mr20 mb20">
                        <?= $agreement['static_text'] ?>
                    </div>
                </div>
            </div>
        </div>
