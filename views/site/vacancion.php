    ...
    <section class="news-item main-content">
        ...
        <div class="wrapper">
            <div class="content-wrapper">
                <?php
                $day = date('d', $onevac['vacancy_date']);
                $month = date('m', $onevac['vacancy_date']);
                $year = date('Y', $onevac['vacancy_date']);
                switch($month) {
                    case '01':
                        $month = 'января';
                        break;
                ...
                <div class="medium-title mb10"><?= $onevac['vacancy_title'] ?></div>
                <div class="news-item">
                    <div class="clearfix">
                        ...
                        <div class="h3 medium text-black mb20">
                            <?= $onevac['vacancy_content'] ?>
                        </div>
                        <img src="../<?= Html::encode($onevac['vacancy_img']) ?>" alt="" class="left mr20 mb20">
                        <?= $onevac['vacancy_full'] ?>
                    </div>
                </div>
            </div>
