    ...
    <section class="news-item main-content">
        ...
        <div class="wrapper">
            <div class="content-wrapper">
                ...
                <div class="medium-title mb10"><?= $antisushi['static_title'] ?></div>
                <div class="news-item">
                    <div class="clearfix">
                        ...
                        <div class="h3 medium text-black mb20">
                            <?= $antisushi['static_preview'] ?>
                        </div>
                        <img src="../<?= $antisushi['static_img'] ?>" alt="" class="left mr20 mb20">
                        <?= $antisushi['static_text'] ?>
                    </div>
                </div>
            </div>
        </div>
