        ...
        <section class="news-item main-content">
            ...
            <div class="wrapper">
                <div class="content-wrapper">
                    <?php
                    $day = date('d', $oner['news_date']);
                    $month = date('m', $oner['news_date']);
                    $year = date('Y', $oner['news_date']);
                    switch($month) {
                        case '01':
                            $month = 'января';
                            break;
...
<!--                     include('tpl/breadcrumbs.php'); -->
                    <div class="medium-title mb10"><?= $oner['news_title'] ?></div>
                    <div class="news-item">
                        <div class="clearfix">
                            ...
                            <img src="../img/<?= Html::encode($oner['news_img']) ?>" alt="" class="left mr20 mb20">
                            <?= $oner['news_full'] ?>
                        </div>
                    </div>
                </div>
